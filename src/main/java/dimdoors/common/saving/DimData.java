...
public class DimData implements Serializable {
	...
	public List<LinkData> findRiftsInRange(World world, int range, int x, int y, int z) {
		LinkData nearest = null;
		List<LinkData> rifts = Lists.newArrayList();
		int i = -range;
		int j = -range;
		int k = -range;
	...
	public boolean isLimbo() {
		return (this.dimID == DimDoorsConfig.category_dimension.limboDimensionID);
	}
